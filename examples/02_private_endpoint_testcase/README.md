...
| <a name="module_private_dns_zone_avd_host_pool"></a> [private\_dns\_zone\_avd\_host\_pool](#module\_private\_dns\_zone\_avd\_host\_pool) | git::ssh://git@ssh.dev.azure.com/v3/ECTL-AZURE/ECTL-Terraform-Modules/terraform-azurerm-privatednszone//module | master |
...
| <a name="module_subnet_private_endpoint"></a> [subnet\_private\_endpoint](#module\_subnet\_private\_endpoint) | git::ssh://git@ssh.dev.azure.com/v3/ECTL-AZURE/ECTL-Terraform-Modules/terraform-azurerm-subnet//module | master |
| <a name="module_vnet"></a> [vnet](#module\_vnet) | git::ssh://git@ssh.dev.azure.com/v3/ECTL-AZURE/ECTL-Terraform-Modules/terraform-azurerm-vnet//module | master |
## Requirements
